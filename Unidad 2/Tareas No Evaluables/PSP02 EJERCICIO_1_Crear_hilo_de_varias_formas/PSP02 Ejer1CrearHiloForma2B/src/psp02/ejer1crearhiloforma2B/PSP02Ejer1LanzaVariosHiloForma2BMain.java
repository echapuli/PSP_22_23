...
public class PSP02Ejer1LanzaVariosHiloForma2BMain {
    public static void main(String[] args) {
        ...
        for(i=1; i<=totalHilos; i++){
          //generamos un tiempo aleatorio para lanzar el hilo  
            ...
            String texto= "Hilo "+i;
            //creamos un objeto runneable
            PSP02Ejer1CrearHiloForma2B  hiloRunneable = new PSP02Ejer1CrearHiloForma2B(texto,tiempo);
